...
export { LugaresBlock } from './LugaresBlock';
export { ImoveisBlock } from './ImoveisBlock';
export { EmpregosBlock } from './EmpregosBlock';
export { ClassificadosBlock } from './ClassificadosBlock';
export { NoticiasBlock } from './NoticiasBlock';
