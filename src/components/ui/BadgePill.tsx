...
const variantConfig: Record<
  BadgeVariant,
  { classes: string; defaultIcon?: LucideIcon }
> = {
  verified: {
  ...
  open: {
    classes:
      "bg-card/95 text-status-open border-status-open/40 backdrop-blur-sm",
    defaultIcon: Clock,
  },
  closed: {
  ...
  rating: {
    classes:
      "bg-foreground/85 text-background border-transparent backdrop-blur-sm",
    defaultIcon: Star,
  },
  default: {
...
export function VerifiedBadge({ className }: { className?: string }) {
  return (
    <BadgePill variant="verified" className={className}>
      Verificado
    </BadgePill>
  );
}
...
export function OpenBadge({ className }: { className?: string }) {
  return (
    <BadgePill variant="open" className={className}>
      Aberto
    </BadgePill>
  );
}
...
export function ClosedBadge({ className }: { className?: string }) {
  return (
    <BadgePill variant="closed" className={className}>
      Fechado
    </BadgePill>
  );
}
